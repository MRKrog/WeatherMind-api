...
import app from './app';
import { cleanAddress, retrieveLocation } from './app';
...
describe('api', () => {
  ...
  describe('get /api/v1/weather/:lat/:long', () => {
    ...
    it('should return expected address when cleanAddress is invoked', () => {
      let expected = {city: "Wheat Ridge", state: "Colorado", street: "3331 Vivian Court"}
      expect(cleanAddress(address)).toEqual(expected);
    })
